...
//		
//	}
//	public static void calcTax(Consultant s) {
//			
//		}
...
//	}
	public static void main(String[] args) {
		...
		// 53줄 void calcTax(Object e) -> static 없는 경우
		// HRSTest349 ht = new HRSTest349(); // 객체 만들고
		// ht.calcTax(s1); // 호출하면 에러 안남
...
// e.calcSalary();
// e -> 변수 : 실행시간에 객체 type 결정
// 객체 type 결정 -> 해당되는 호출함수의 body가 결정. -> 동적 binding / polymorphism
// calcSalary -> 호출함수명